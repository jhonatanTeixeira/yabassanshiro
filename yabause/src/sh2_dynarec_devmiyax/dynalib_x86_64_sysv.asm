...
; GenReg => edi
; SysReg => esi
; SYSV-ADAPT: arg1 (GenReg base ptr) arrives in RDI under the Linux SysV
; ABI (Windows used RCX). RDI already holds the value we want to keep, so
; instead of copying RCX->RDI we copy RDI->RCX to reuse the same offset
; arithmetic below -- same instruction, same byte count, PROLOGSIZE unchanged.
; Size = 27 Bytes
global prologue
prologue:
pushaq
mov r14, 00      ;4 (JumpAddr)
mov rcx,rdi        ;2 (GenReg already in rdi, arg1 under SysV)
add rcx,byte 64    ;3
mov rbx,rcx        ;2 (SR)
add rcx,byte 12    ;3
...
seperator_d_normal:
add dword [r12+4],byte 1 ;4 Clock += 1
push rdi                      ; SYSV-ADAPT: save GenReg
push rsi                      ; SYSV-ADAPT: save SysReg
mov  rax,DebugEachClock ;5
call rax                 ;2
pop rsi                       ; SYSV-ADAPT: restore SysReg
pop rdi                       ; SYSV-ADAPT: restore GenReg
...
opdesc SLEEP,	35,0xff,0xff,0xff,0xff,0xff
opfunc SLEEP
...
opdesc ADDC,	34,6,16,0xff,0xff,0xff
opfunc ADDC
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbp]       ;3
...
opdesc SUBC,	34,6,16,0xff,0xff,0xff
opfunc SUBC
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbp]       ;3
...
opdesc NEGC,	49,6,18,0xff,0xff,0xff
opfunc NEGC
mov rbp,rdi               ;2
add rbp,byte $00          ;3
mov ecx,[rbp]             ;3
...
opdesc STC_SR_MEM,	36,0xff,6,0xff,0xff,0xff
opfunc STC_SR_MEM
mov  rbp,rdi            ;2
add  rbp,byte $00       ;3
mov  edx, [rbx]        ;2
...
push rdi                      ; SYSV-ADAPT: save GenReg
push rsi                      ; SYSV-ADAPT: save SysReg
mov edi, ecx                  ; SYSV-ADAPT: arg1 Win ECX -> SysV EDI
mov esi, edx                  ; SYSV-ADAPT: arg2 Win EDX -> SysV ESI
...
opdesc STC_GBR_MEM,	44,0xff,16,0xff,0xff,0xff
opfunc STC_GBR_MEM
mov  rbp,rdi            ;2
add  rbp,byte 68        ;3
mov  edx,[rbp]          ;3
...
opdesc STC_VBR_MEM,	44,0xff,16,0xff,0xff,0xff
opfunc STC_VBR_MEM
mov  rbp,rdi            ;2
add  rbp,byte 72        ;3
mov  edx,[rbp]          ;3
...
opdesc MOVBL,	41,6,34,0xff,0xff,0xff
opfunc MOVBL
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
opdesc MOVWL,		39,6,34,0xff,0xff,0xff
opfunc MOVWL
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
opdesc MOVL_MEM_REG,		38,6,34,0xff,0xff,0xff
opfunc MOVL_MEM_REG
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
opdesc MOVBP,	44,6,37,0xff,0xff,0xff
opfunc MOVBP
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
opdesc MOVWP,	43,6,38,0xff,0xff,0xff
opfunc MOVWP
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
opdesc MOVLP,	42,6,38,0xff,0xff,0xff
opfunc MOVLP
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
;?????? need to check
opdesc MOVW_A, 53,0xff,6,0xff,16,0xff
opfunc MOVW_A
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[r12]       ;2
...
opdesc MOVL_A,	57,0xff,6,0xff,16,0xff
opfunc MOVL_A
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[r12]       ;2
...
opdesc MOVBL0,	43,6,36,0xff,0xff,0xff
opfunc MOVBL0
mov rbp,rdi          ;2
add rbp,byte $00     ;3
mov ecx,[rbp]        ;3
...
opdesc MOVWL0,	41,6,36,0xff,0xff,0xff
opfunc MOVWL0
mov rbp,rdi          ;2
add rbp,byte $00     ;3
mov ecx,[rbp]        ;3
...
opdesc MOVLL0,	40,6,36,0xff,0xff,0xff
opfunc MOVLL0
mov rbp,rdi          ;2
add rbp,byte $00     ;3
mov ecx,[rbp]        ;3
...
opdesc MOVT,		15,0xff,6,0xff,0xff,0xff
opfunc MOVT
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbx]       ;2
...
opdesc MOVBS0,	42,6,16,0xff,0xff,0xff
opfunc MOVBS0
mov  rbp,rdi         ;2
...
opdesc MOVWS0, 42,6,16,0xff,0xff,0xff
opfunc MOVWS0
mov  rbp,rdi         ;2
add  rbp,byte $00    ;3 m(4..7)
mov  edx, [rbp]     ;3
...
opdesc MOVLS0,	42,6,16,0xff,0xff,0xff
opfunc MOVLS0
mov  rbp,rdi         ;2
add  rbp,byte $00    ;3 m(4..7)
mov  edx, [rbp]     ;3
...
opdesc CMP_PL,	19,0xff,6,0xff,0xff,0xff
opfunc CMP_PL
mov rbp,rdi                 ;2
add rbp,byte $00            ;3
...
opdesc ROTCL,	30,0xff,6,0xff,0xff,0xff
opfunc ROTCL
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbx]       ;2
...
opdesc ROTCR,	33,0xff,6,0xff,0xff,0xff
opfunc ROTCR
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbx]       ;2
...
opdesc SHLR,	22,0xff,6,0xff,0xff,0xff
opfunc SHLR
mov rbp,rdi                 ;2
add rbp,byte $00            ;3
mov eax,[rbp]               ;3
...
opdesc SHAR,	22,0xff,6,0xff,0xff,0xff
opfunc SHAR
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbp]       ;2
...
opdesc AND_B,	56,0xff,0xff,0xff,32,0xff
opfunc AND_B
...
opdesc OR_B,	56,0xff,0xff,0xff,32,0xff
opfunc OR_B
ctrlreg_load 1      ;5 GBR to rbp
...
opdesc XOR_B,	56,0xff,0xff,0xff,32,0xff
opfunc XOR_B
ctrlreg_load 1      ;5 GBR to rbp
mov  ecx, [rbp]       ;3 Get GBR
add  ecx, dword [rdi] ;2 ADD R0
...
opdesc TST_B,	42,0xff,0xff,0xff,37,0xff
opfunc TST_B
ctrlreg_load 1        ;5
mov  ecx,[rbp]        ;3 Get GBR
...
opdesc RTE,			70,0xff,0xff,0xff,0xff,0xff
opfunc RTE
mov  rbp,rdi            ;2
add  rbp,byte 60        ;3
mov  ecx, [rbp]        ;3
...
opdesc TRAPA,	      107,0xff,0xff,0xff,79,0xff
opfunc TRAPA
mov  rbp,rdi          ;2
add  rbp,byte 60      ;3
sub  dword [rbp],4    ;7
...
opdesc BT,		29,0xFF,0xFF,0xFF,18,0xFF
opfunc BT
and r14d,dword 0   ;7
bt dword [rbx],0    ;4
jnc .continue       ;2
...
opdesc BF,		29,0xFF,0xFF,0xFF,18,0xFF
opfunc BF
and r14d,dword 0   ;7
bt dword [rbx],0    ;4
jc .continue        ;2
...
opdesc STS_MACH_DEC,	36,0xff,6,0xff,0xff,0xff
opfunc STS_MACH_DEC
mov rbp,rdi       ;2
add rbp,byte $00  ;3
...
opdesc STS_MACL_DEC,	37,0xff,6,0xff,0xff,0xff
opfunc STS_MACL_DEC
mov rbp,rdi       ;2
add rbp,byte $00  ;3
sub dword [rbp],byte 4 ;3
...
opdesc LDC_SR_INC,	40,0xff,6,0xff,0xff,0xff
opfunc LDC_SR_INC
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov rcx,[rbp]       ;2
...
opdesc LDC_GBR_INC,	42,0xff,6,0xff,0xff,0xff
opfunc LDC_GBR_INC
mov  rbp,rdi            ;2
add  rbp,byte $00       ;3
mov  ecx,[rbp]          ;2
...
opdesc LDC_VBR_INC,	42,0xff,6,0xff,0xff,0xff
opfunc LDC_VBR_INC
mov  rbp,rdi            ;2
add  rbp,byte $00       ;3
mov  ecx,[rbp]          ;2
...
opdesc STSMPR,	37,0xff,6,0xff,0xff,0xff
opfunc STSMPR
mov rbp,rdi       ;2
add rbp,byte $00  ;3
sub dword [rbp],byte 4 ;3
...
opdesc LDS_PR_INC,	35,0xff,6,0xff,0xff,0xff
opfunc LDS_PR_INC
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[rbp]       ;3
...
opdesc LDS_MACH_INC,	34,0xff,6,0xff,0xff,0xff
opfunc LDS_MACH_INC
mov rbp,rdi            ;2
add rbp,byte $00       ;3
mov ecx,[rbp]          ;2
...
opdesc LDS_MACL_INC,	35,0xff,6,0xff,0xff,0xff
opfunc LDS_MACL_INC
mov rbp,rdi            ;2
add rbp,byte $00       ;3
mov ecx,[rbp]          ;2
...
opdesc MOVWI,	44,0xff,6,0xff,10,0xff
opfunc MOVWI
mov rbp,rdi         ;2
add rbp,byte $00    ;3
xor ecx,ecx         ;2
...
opdesc MOVLI,       49,0xff,6,0xff,11,0xff
opfunc MOVLI
mov rbp,rdi         ;2
add rbp,byte $00    ;3
xor rax,rax         ;2
...
opdesc MOVBL4, 41,6,0xff,10,0xff,0xff
opfunc MOVBL4
...
opdesc MOVWL4, 43,6,0xff,10,0xff,0xff
opfunc MOVWL4
mov  rbp,rdi          ;2  Get R0 adress
add  rbp,byte $00     ;3
xor  ecx,ecx          ;2  Clear Eax
...
opdesc MOVLL4, 46,6,42,10,0xff,0xff
opfunc MOVLL4
mov  rbp,rdi          ;2  Get R0 adress
add  rbp,byte $00     ;3
xor  ecx,ecx          ;2  Clear Eax
...
opdesc MOVBS4,	40,9,0xff,18,0xff,0xff
opfunc MOVBS4
...
opdesc MOVWS4,	42,9,0xff,18,0xff,0xff
opfunc MOVWS4
mov rbp,rdi         ;2  Get R0 address
mov edx, [rbp]      ;3  Set to Func
add rbp,byte $00    ;3  Get Imidiate value R[n]
...
opdesc MOVLS4,	50,6,16,24,0xff,0xff
opfunc MOVLS4
mov  rbp,rdi         ;2 
...
opdesc MOVBLG,    34,0xff,0xff,0xff,6,0xff
opfunc MOVBLG
mov  rbp,rdi           ;2  Get R0 adress
xor  ecx,ecx           ;2  clear eax
...
opdesc MOVWLG,    36,0xff,0xff,0xff,6,0xff
opfunc MOVWLG
mov  rbp,rdi           ;2  Get R0 adress
xor  ecx,ecx           ;2  clear eax
mov  cl,00             ;2  Get Imidiate Value
...
opdesc MOVLLG,    35,0xff,0xff,0xff,6,0xff
opfunc MOVLLG
mov  rbp,rdi           ;2  Get R0 adress
xor  ecx,ecx           ;2  clear eax
...
opdesc MOVBSG,    40,0xff,0xff,0xff,9,0xff
opfunc MOVBSG
mov  rbp,rdi         ;2  Get R0 adress
mov  edx,[rbp]       ;3
xor  ecx,ecx         ;2  Clear Eax
...
opdesc MOVWSG,    44,0xff,0xff,0xff,9,0xff
opfunc MOVWSG
mov  rbp,rdi         ;2  Get R0 adress
mov  edx,[rbp]       ;3
xor  ecx,ecx         ;2  Clear Eax
...
opdesc MOVLSG,    44,0xff,0xff,0xff,9,0xff
opfunc MOVLSG
mov  rbp,rdi         ;2  Get R0 adress
mov  edx, [rbp]     ;3
xor  ecx,ecx         ;2  Clear Eax
...
opdesc MOVBS,	40,6,16,0xff,0xff,0xff
opfunc MOVBS
mov  rbp,rdi         ;2
add  rbp,byte $00    ;3
mov  edx, [rbp]     ;3
...
opdesc MOVWS,	40,6,16,0xff,0xff,0xff
opfunc MOVWS
mov  rbp,rdi          ;2
add  rbp,byte $00     ;3
mov  edx, [rbp]      ;3
...
opdesc MOVLS,	40,6,16,0xff,0xff,0xff
opfunc MOVLS
mov  rbp,rdi         ;2
add  rbp,byte $00    ;3
mov edx, [rbp]     ;3
...
opdesc MOVBM,		44,6,16,0xff,0xff,0xff
opfunc MOVBM
mov  rbp,rdi             ;2
add  rbp,byte $00        ;3  
...
opdesc MOVWM,		44,6,16,0xff,0xff,0xff
opfunc MOVWM
mov  rbp,rdi             ;2
add  rbp,byte $00        ;3  
mov  edx, [rbp]         ;3 Set data
...
opdesc MOVLM,		44,6,16,0xff,0xff,0xff
opfunc MOVLM
mov  rbp,rdi             ;2
add  rbp,byte $00        ;3  
mov  edx, [rbp]         ;3 Set data
...
opdesc TAS,  70,0xff,6,0xff,0xff,0xff
opfunc TAS
mov  rbp,rdi             ;2
add  rbp,byte $00        ;3
mov  rcx, [rbp]         ;3
...
; string cmp
opdesc CMPSTR, 61,6,16,0xFF,0xFF,0xFF
opfunc CMPSTR
mov  rbp,rdi          ;2
add  rbp,byte $00     ;3
mov  eax,[rbp]        ;3
...
;-------------------------------------------------------------
;div0s 
opdesc DIV0S, 78,41,6,0xFF,0xFF,0xFF
opfunc DIV0S
mov  rbp,rdi                 ;2 SetQ
...
;===============================================================
opdesc DIV1, 389,67,6,0xFF,0xFF,0xFF
opfunc DIV1
...
;        (MACH << 32 + MACL)  + ans 
;-------------------------------------------------------------
opdesc MAC_L, 157,6,44,0xff,0xff,0xff
opfunc MAC_L
mov  rbp,rdi                  ;2  
add  rbp,byte $00             ;3 4..7
mov  ecx,dword [rbp]          ;3
...
;        (MACH << 32 + MACL)  + ans 
;-------------------------------------------------------------
opdesc MAC_W, 123,6,45,0xff,0xff,0xff
opfunc MAC_W
mov  rbp,rdi                  ;2  
add  rbp,byte $00             ;3 4..7
mov  ecx,dword [rbp]          ;3
...
; Mark this object as not requiring an executable stack (the JIT's actual
; executable buffer is a separate mmap'd region, unrelated to this section).
